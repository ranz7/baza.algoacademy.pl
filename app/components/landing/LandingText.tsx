const LandingText = () => {
  return <div className='flex flex-col items-center gap-6 text-center px-4 py-12 lg:py-24'>
    <div className='flex  gap-2 lg:gap-4 items-center'>
      ...
      >
            <span
              className={`
            inline-block  bg-clip-text bg-gradient-to-r from-sky-400 to-indigo-500 text-transparent
